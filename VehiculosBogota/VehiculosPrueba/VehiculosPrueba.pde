...
//VARIABLES PARA LA LECTURA DE DATOS  
 ...
 void setup(){
  ...
  continuar = new Boton("CONTINUAR", 13, width/2-50, height/2+50, colorB1, #37c9ef, colorT1);
  total = new Boton("TOTAL", 13, width/2-200, 600, 0, #37c9ef, colorB1);
  localidades = new Boton("LOCALIDADES", 13, width/2+100, 600, 0, #37c9ef, colorB1);
...
void mouseMoved() {
 ...
 void pagina0(){
   ...
   fill(0,0,100);
   textFont(fuente);
   text("¿Dónde está la Gente Humo?", width/2, 300);
   popMatrix();
...
void verParticulasPrin(){
     ArrayList<ParticleBig> a1 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a2 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a3 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a4 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a5 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a6 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a7 = new ArrayList<ParticleBig>();
     ArrayList<ParticleBig> a8 = new ArrayList<ParticleBig>();
     
     for (int i = 0; i < totalC[0]/1000; i++){
       a1.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[1]/1000; i++){
       a2.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[2]/1000; i++){
       a3.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[3]/1000; i++){
       a4.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[4]/1000; i++){
       a5.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[5]/1000; i++){
       a6.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[6]/1000; i++){
       a7.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
     for (int i = 0; i < totalC[7]; i++){
       a8.add(new ParticleBig(2, width/2, height/2-40, width/2, height/2));
     }
...
/*void mostrarParticulas(ArrayList<ArrayList<ParticleBig>> a, int theme, int begX, int begY, int endX, int endY){
 
  datoTotal= totalC[valorSlider]/1000;
  if(unaVez == false){
    println("VALOR DATO TOTAL" + datoTotal);
    for (int i = 0; i < datoTotal; i++) {
      a.add(new ArrayList(new ParticleBig(theme, begX, begY, endX, endY)));
      println("TAMAÑO ARREGLO:" +a.size()) ;
    }
  }
  unaVez = true;
